...
def create_app():
    ...
    login_manager.login_view = 'auth.login' # Template and function name
    login_manager.init_app(app)
    
    @login_manager.user_loader
    def load_user(id):
        return User.query.get(int(id)) # Querying the database to find a user by their primary key id
